...
func (m Model) headersView() string {
	...
	for _, col := range m.cols {
		...
		renderedCell := style.Render(runewidth.Truncate(col.Title, col.Width-2, "…"))
...
func (m *Model) renderRow(rowID int) string {
	...
	for i, value := range m.rows[rowID] {
		...
		renderedCell := m.styles.Cell.Render(style.Render(runewidth.Truncate(value, m.cols[i].Width-2, "…")))
